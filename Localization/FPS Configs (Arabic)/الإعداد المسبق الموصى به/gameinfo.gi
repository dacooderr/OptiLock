...
// Deadlock Mod Manager - End
    ...
    ConVars
    {
						  ...
						  //																	    \\
                                                                                                                         \\    إذا كنت ترغب في التبرع كوسيلة للتعبير عن الشكر (أو إظهار الامتنان )    //
						//                 https://streamlabs.com/dacooderr/tip                       \\
						
				// ================ PREFERENCES ================ التفضيلات
                // def = الاعداد الاصلي قبل التعديل
				// --- OUTLINES --- الحدود الخارجية
				citadel_trooper_glow_disabled                           "1"  // 1 = تعطيل توهج الجنود الاصدقاء/العدو (منيونز).                          [def: "0"]
				citadel_boss_glow_disabled                              "1"  // تعطيل توهج /تحديد الزعيم و وَالآلِيِّينَ (الوالكرز).                  [def: "0]
				r_citadel_npr_outlines_max_dist                         "600"  // تحديد مسافة الحدود الخارجية لتقليل المعالجة الغير ضرورية.        [def: "1000"]
				r_citadel_selection_outline2_alpha                      "0.8"  // الحدود الخارجية على الاعبين الاعداء و القدرات بمقياس من 0-1.       [def: "0.8"]
				r_citadel_npr_outlines                                  "true"  // تفعيل الحدود الخارجية على الاعبين الاعداء.                                [def: "true"]
				r_citadel_outlines                                      "1"  // تفعيل الحدود الخارجية لرؤية الاعداء بصورة أفضل.
				citadel_hud_objective_health_enabled        			"2" // [تعديل] عرض صحة الاهداف-0 اطفاء | 1-المعابد فقط | 2-ابراج مستوئ الاول وثاني | 3- الثكنات
				citadel_player_glow_disabled                            "0"  // تعطيل تأثير التوهج/تحديد الاعب عند الاشارة إِلية.               [def: "0"]
				...
				// --- HIT MARKER/HEALTHBAR --- علامات الاصابة و شريط الصحة
				citadel_unit_status_use_new                             "1"      // تفعيل شريط الصحة الجديد. قد تكون مطلوبة من بعض المودات (الاضافات) وقد يتسبب في اغلاق العبة  . (غيرها الى 0 أو False لاستخدام الشريط القديم)
				//citadel_crosshair_hit_marker_duration                 "0.01"   // أزالة علامات الاصابة عند ضرب الاشخاص (الاعداء).                      [def: "0.1"]
				r_citadel_glow_health_bars                				"false"  // ازالة تأثير التوهج من شريط الصحة
				 
				// ================ FOV ================ مجال الرؤية
				r_aspectratio 											"2.15"   // [تعديل] FOV control: 1.33=70fov | 1.56=75fov | 1.75=80fov | 2.0=85fov | 2.15=90fov | 2.49=100fov | 3.0=110fov | 3.5=120fov تحكم في مجال الرؤية
				citadel_camera_hero_fov                                 "100"    // زاوية مجال الرؤية للكامرة عند الإلحاق في البطل   [def: "90"]

				// ==== COLOR ACCURACY & POST PROCESSING ==== دقة الأَلْوَانِ & المعالجة البعدية

				//  ---- IMPORTANT  ---- مهم
				mat_colorcorrection 									"false"  //  دقة الالوان
				r_postprocess_enable                                    "true"  //  تعطيل تأثير المعالجة اللاحقة في العبة كاملة. تجعل العبة مظلمة جدا. (يمكن التحكم فيهم في كونفارز في قسم المعالجة اللاحقة لأنهم تأثيرات في المعالجة الاحقة)
				
				//  ---- Optional Effects ---- التأثيرات الاختيارية
				r_effects_bloom                           				"false" 
				r_depth_of_field                          				"false" 	
				r_citadel_distancefield_blur							"false"
				fx_drawmetalspark                 						"false" //الافتراضي: مفعل رسم تأثيرات شرارة المعادن.
				
				// --- RENDER DISTANCE --- مسافة العرض
				r_mapextents                      "12000"
				r_farz 							  "10000"  						//-↴
                            //تغير المدى الذي يتم فيه عرض الـ (3dskybox) بعيداً عن بطلِك، عدل هاتين القيمتين حسب رغبتك لتقليل مشاكل العرض (Rendering)
				r_nearz      					  "10"
				...
				citadel_visibility_queue_rate        					"4" 			
				 ...
				 //CREDITS الحقوقُ وَالمُسَاهِمُونَ																				                                                                 \\
				// dacooder    Config Creator منشائ ملف الاعدادات           												                                                               	      \\
			   // Xeraa		   Helped fix a major issue with console spam and fps drops late game ساهم هي اصلاح مشاكل كبيرةتتعلق بكثرة الرسائل في الكونسل وهبوط الفريمات اخر العبة			   \\
			  // Boot		   ConVar Contribution          ساهم في اوامر المتغيرات 									                                                         		        \\
			 // Kaiz		   ConVar Contribution          ساهم في اوامر المتغيرات                                                                                                              \\
			// simcasting 	   Benchmarking                  أختبار و قياس الاداء          																		                                  \\
		   // Artemon121       Made the Citadel cvar unhider    صنع أداة اضهار أَوامر المخفية في العبة                                         													   \\
		  // Pidjan            Worked on further gameinfo changes and let us integrate     عمل على تعديلات إِضافيةفي ملف العبة و سمح لنا بدمجها                                                       \\
		 // Piggy              Video.txt contributer and cool streamer guy  ساهم في ملف الفيديو و صانع محتوائ رائع                                                                                   \\
