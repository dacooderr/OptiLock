# This is BOOT'S POTATO config. This config is known to cause visual bugs and other issues that might effect competitive play. If you want **roblox graphics**, make sure to change r_texture_stream_mip_bias in VIDEO.TXT. **DO NOT MAKE GAMEINFO OR VIDEO.TXT READONLY.**
