# This is the core "High-End" OptiLock FPS config that supports custom maps. If you want **roblox graphics**, make sure to change r_texture_stream_mip_bias in VIDEO.TXT. **DO NOT MAKE GAMEINFO OR VIDEO.TXT READONLY.**
